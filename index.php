  ...
  <div id="content">
    ...
    <div id="main">
      ...
      <div class="box">
        ...
        <p>
        <?php
        	$desc = _("This site is a compilation of some of my programming projects in various languages. " .
			...
			"The full source code of this entire site is available as a public ".
